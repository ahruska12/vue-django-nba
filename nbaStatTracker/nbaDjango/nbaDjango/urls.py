...
urlpatterns = [
    ...
    path('favorite/team/', views.favorite_team_list),
    path('favorite/player/', views.favorite_player_list),
    url(r'^api/favorite/team/(?P<pk>[0-9]+)$', views.getFavoriteTeam),
    url(r'^api/favorite/player/(?P<pk>[0-9]+)$', views.getFavoritePlayer),
